          ...
          <section className="bg-card border border-border rounded-lg p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                <label key={key} className={`flex items-start gap-2.5 p-3 rounded-lg border cursor-pointer transition-colors ${
                  form[key as keyof typeof form] ? 'border-orange-200 bg-orange-50' : 'border-border hover:bg-muted/30'
                }`}>
