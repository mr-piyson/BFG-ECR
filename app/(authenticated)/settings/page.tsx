                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Get notified when an ECR is assigned</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Get notified when a stage is completed</p>
                      </div>
                      <input type="checkbox" className="w-5 h-5" defaultChecked />
                    </div>
