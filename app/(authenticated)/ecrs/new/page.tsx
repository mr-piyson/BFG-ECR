...
export default function NewECRPage() {
  ...
  const [engineers, setEngineers] = useState<{ design: any[], project: any[] }>({ design: [], project: [] });
  ...
  useEffect(() => {
    ...
    const fetchProjectDetails = async () => {
      ...
      try {
        ...
        const pes = allUsers.filter((u: any) => u.role === "PROJECT_ENGINEER" || u.role === "ADMIN");
    ...
    <div className="p-8 max-w-2xl">
            ...
            <Card className="p-8 shadow-lg border-primary/10">
              <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    {formData.project_id && (
                      <div className="space-y-3 animate-in fade-in slide-in-from-top-2 duration-300">
                        ...
                        <div className="grid grid-cols-2 gap-3 p-4 bg-muted/30 rounded-xl border border-border/50">
                          {fetchingDetails ? (
                            <p className="text-xs text-muted-foreground animate-pulse">Loading scopes...</p>
                          ) : scopes.length === 0 ? (
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        placeholder={formData.source === "CUSTOMER" ? "Customer Company Name" : "Internal Department"}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        onValueChange={(val) => setFormData(prev => ({ ...prev, design_engineer_id: val }))}
                        required
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        onValueChange={(val) => setFormData(prev => ({ ...prev, project_engineer_id: val }))}
                      >
                ...
                {/* Description Section */}
                <div className="space-y-4 pt-4 border-t">
                  <Label htmlFor="change_description" className="text-primary font-semibold flex items-center gap-2">
                ...
                <div className="pt-6 border-t">
                  <Label className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Workflow Customization</Label>
                  <div className="grid grid-cols-2 gap-y-3 mt-4">
                    {[
                      ...
                      <label key={stage.id} className="flex items-center gap-2 group cursor-pointer">
                        ...
                        />
                        <span className="text-sm group-hover:text-primary transition-colors">{stage.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
