  ...
  return (
    <div className="bg-card border border-border rounded-lg">
        ...
        <div className="flex items-center gap-0 overflow-x-auto">
          {STAGE_TABS.map((tab) => (
            <button
              ...
              className={cn(
                'flex-shrink-0 px-4 py-2.5 text-sm transition-colors border-b-2 -mb-px',
                activeTab === tab.id
      ...
      <div className="p-4">
        ...
        {activeTab === 'history' && (
          <AuditTrail histories={stageHistories} />
        )}
      </div>
    </div>
  )
            ...
            <div key={h.id} className="relative flex items-start gap-4 pl-10">
              ...
              <div className="flex-1 bg-muted/30 border border-border rounded-lg p-3">
                <div className="flex items-start justify-between gap-2 mb-1">
                  ...
                  <span className="text-[10px] text-muted-foreground flex-shrink-0">{formatDatetime(h.created_at)}</span>
                </div>
